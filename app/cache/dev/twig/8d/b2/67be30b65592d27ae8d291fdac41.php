...
class __TwigTemplate_8db267be30b65592d27ae8d291fdac41 extends Twig_Template
{
...
";
    ...
    <span class=\"count\">
        ";
        // line 13
        if (twig_template_get_attributes($this, (isset($context["collector"]) ? $context["collector"] : $this->getContext($context, "collector")), "hasexception")) {
            // line 14
            echo "            <span>1</span>
        ";
        }
...
";
    ...
    ";
            ...
            // line 28
            echo "        ";
            echo $this->env->getExtension('actions')->renderAction("WebProfilerBundle:Exception:show", array("exception" => twig_template_get_attributes($this, (isset($context["collector"]) ? $context["collector"] : $this->getContext($context, "collector")), "exception"), "format" => "html"), array());
            // line 29
            echo "    ";
        }
    }
